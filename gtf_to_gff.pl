...
# mdb downloaded from SEQAnswers forum 11/22/10 (http://seqanswers.com/forums/showthread.php?t=3201&highlight=GFF3)
...
while (<>) {
	...
	#$v[0] = 'chr' . $v[0] unless index($v[0], 'chr') == 0; # mdb removed 11/22/10
